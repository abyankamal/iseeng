...
<div class="container mx-auto min-vh-100" style="padding-top: 20px;">
  <div class="text-center" style="padding-bottom: 60px;">
    <h1 class="fs-1 fw-bold text-white">Halaman Edit Produk</h1>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="col card">
        <div class="card-body w-100">
          ...
          ?>
            <form action="proses/proseseditproduk.php" method="post" enctype="multipart/form-data">
              <div class="mb-3">
                ...
                <input type="text" name="name" value="<?= $row['name'] ?>" class="form-control" id="exampleFormControlInput1" placeholder="Masukan Nama Anggota">
              </div>
              <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Deskripsi</label>
                <textarea name="description" value="<?= $row['description'] ?>" class="form-control" id="exampleFormControlTextarea1" rows="3"><?= $row['description'] ?></textarea>
              </div>
              <!-- <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="number" value="<?= $row['price'] ?>" name="price" class="form-control" id="exampleFormControlInput1" placeholder="Masukan Nama Anggota">
              </div>
              <label for="exampleFormControlInput1" class="form-label">Kategori</label>
              <div class="mb-3">
                <select class="form-select" value="<?= $row['category'] ?>" name="category" aria-label="Default select example" placeholder="Tes" required>
