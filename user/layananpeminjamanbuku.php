...
<div class="container mx-auto min-vh-100" style="padding-top: 20px;">
  <div class="text-center" style="padding-bottom: 60px;">
    <h1 class="fs-1 fw-bold text-white">Layanan Peminjaman Buku</h1>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="col card">
          ...
          <table id="table" class="table table-bordered">
            ...
            ?>
              <tr>
                ...
                <td>
                  <img src="../assets/buku/<?= $row['gambar_buku']?>" alt="" srcset="" width="50" height="70">
                </td>
                <td><?= $row['sinopsis']?></td>
                <td><?= $row['jumlah_buku']?></td>
                <td><?= $row['biaya_sewa']?></td>
                <td>
                  <a href="pinjambuku.php?id=<?= $row['id_buku']?>" class="btn btn-dark"><i class="fa-solid fa-book"></i></a>
                </td>
              </tr>
            </tbody>
            <?php endforeach; ?>
